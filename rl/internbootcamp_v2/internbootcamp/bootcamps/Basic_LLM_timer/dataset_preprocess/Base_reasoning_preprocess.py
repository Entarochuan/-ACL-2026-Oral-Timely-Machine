            ...
            return dict(
                ...
                reward_model={
                    "ground_truth": {
                        ...
                        "timer_speed_factor": sampled_speed_factor,
                        "answer": ref_answer, 
                        "question": example["messages"][0].get("content", ""),
                        "data_type": "general_reasoning", 
                        "with_time_limit": True,
                    },
                    "style": "rule"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--local_dir", default="./data/mix_train/general_reasoning_1229_AM_origRL", help="The save directory for the preprocessed dataset.")
    parser.add_argument("--hdfs_dir", default=None)
    parser.add_argument("--local_load_path", default="/path/to/am_0.9M.jsonl", help="The local path to the raw dataset.")
    parser.add_argument("--num_samples", type=int, default=20000, help="Number of samples to load. If None, load all.")
    parser.add_argument("--test_size", type=int, default=100, help="Number of samples for test set.")

    parser.add_argument("--min_duration", type=float, default=10.0, help="The minimum duration for the task.")
    parser.add_argument("--mid_duration", type=float, default=20.0, help="The middle duration for the task.")
    parser.add_argument("--max_duration", type=float, default=60.0, help="The maximum duration for the task.")
    parser.add_argument("--min_timer_speed_factor", type=float, default=0.5, help="The timer speed factor.")
    parser.add_argument("--mid_timer_speed_factor", type=float, default=1.0, help="The middle timer speed factor.")
    parser.add_argument("--max_timer_speed_factor", type=float, default=2.0, help="The maximum timer speed factor.")

    parser.add_argument("--orig_prob", type=float, default=1.0, help="The probability of the original task.(Without time limit.)")
